...
function PromptTab({
  ...
  return (
    <Field
      ...
      hint="Override the default DeepSex persona. Leave empty to use the built-in prompt. Tool docs, skills, memory, and effort guidance are always appended automatically."
    >
      <textarea
